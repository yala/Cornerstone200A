...
class NLST(pl.LightningDataModule):
    ...
    def __init__(
            ...
            batch_size=1,
            num_workers=0,
            nlst_metadata_path="/wynton/protected/group/yala/datasets/nlst-metadata/full_nlst_google.json",
            valid_exam_path="/wynton/protected/group/yala/datasets/nlst-metadata/valid_exams.p",
            nlst_dir="/scratch/datasets/nlst/preprocessed",
            lungrads_path="/wynton/protected/group/yala/datasets/nlst-metadata/nlst_acc2lungrads.p",
            num_images=200,
            max_followup=6,
            img_size = [256, 256],
            class_balance=False,
